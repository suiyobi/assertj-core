...
public class Boolean2DArrayAssert extends Abstract2DArrayAssert<Boolean2DArrayAssert, boolean[][], Boolean> {
   ...
   * Example:
   * <pre><code class='java'> // assertion will pass
   * assertThat(new boolean[][] {{true, false, true}, {true, false}}).hasNumberOfRows(2);
   *
   * // assertions will fail
   * assertThat(new boolean[][] { }).hasNumberOfRows(1);
   * assertThat(new boolean[][] {{true, false, true}, {true, false, true}, true}).hasNumberOfRows(3); </code></pre>
   *
   ...
   */
  @Override
  public Boolean2DArrayAssert hasNumberOfRows(int expectedRowNum) {
