...
public class Char2DArrayAssert extends Abstract2DArrayAssert<Char2DArrayAssert, char[][], Character> {
   ...
   * Example:
   * <pre><code class='java'> // assertion will pass
   * assertThat(new char[][] {{'1', '2', '3'}, {'4', '5'}}).hasNumberOfRows(2);
   *
   * // assertions will fail
   * assertThat(new char[][] { }).hasNumberOfRows(1);
   * assertThat(new char[][] {{'1', '2', '3'}, {'4', '5', '6', '7'}}).hasNumberOfRows(3); </code></pre>
   *
   ...
   */
  @Override
  public Char2DArrayAssert hasNumberOfRows(int expectedRowNum) {
