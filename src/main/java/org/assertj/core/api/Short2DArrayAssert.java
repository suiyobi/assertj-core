...
public class Short2DArrayAssert extends Abstract2DArrayAssert<Short2DArrayAssert, short[][], Short> {
   ...
   * Example:
   * <pre><code class='java'> // assertion will pass
   * assertThat(new short[][] {{1, 2, 3}, {4, 5}}).hasNumberOfRows(2);
   *
   * // assertions will fail
   * assertThat(new short[][] { }).hasNumberOfRows(1);
   * assertThat(new short[][] {{1, 2, 3}, {4, 5, 6, 7}}).hasNumberOfRows(3); </code></pre>
   *
   ...
   */
  @Override
  public Short2DArrayAssert hasNumberOfRows(int expectedRowNum) {
