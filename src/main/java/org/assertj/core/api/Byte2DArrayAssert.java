...
public class Byte2DArrayAssert extends Abstract2DArrayAssert<Byte2DArrayAssert, byte[][], Byte> {
   ...
   * Example:
   * <pre><code class='java'> // assertion will pass
   * assertThat(new byte[][] {{1, 2, 3}, {4, 5}}).hasNumberOfRows(2);
   *
   * // assertions will fail
   * assertThat(new byte[][] { }).hasNumberOfRows(1);
   * assertThat(new byte[][] {{1, 2, 3}, {4, 5, 6, 7}}).hasNumberOfRows(3); </code></pre>
   *
   ...
   */
  @Override
  public Byte2DArrayAssert hasNumberOfRows(int expectedRowNum) {
